...
- сохраняет текст входящих сообщений;
- сохраняет подписи к сообщениям, если у сообщения нет обычного текста;
...
- работает без Telethon, Pyrogram и userbot;
- не требует веб-панели, оплаты, аналитики и админ-панели.
